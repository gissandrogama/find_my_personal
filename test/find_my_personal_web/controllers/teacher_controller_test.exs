defmodule FindMyPersonalWeb.TeacherControllerTest do
  ...
  describe "create teacher" do
    ...
    test "renders teacher when data is valid", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ "Cadastro criado com sucesoo!"
    end
  ...
  describe "edit teacher" do
    ...
    test "renders form editing chosen teacher", %{conn: conn, teacher: teacher} do
      conn = get(conn, Routes.teacher_path(conn, :edit, teacher))
      assert html_response(conn, 200) =~ "Editar Perfil"
    end
  end
  ...
  describe "update teacher" do
    ...
    test "redirects when data is valid", %{conn: conn, teacher: teacher} do
      ...
      assert html_response(conn, 200) =~ "Perfil atualizado com sucesoo!"
    end
